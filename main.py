...
async def main():
    ...
    try:
        broker_adapter = BrokerAdapter(config_manager, logger, notification_service)
    except Exception as e:
...
System is now in test mode. Monitoring all components.
            ...
            try:
                if data_manager and trading_system:
